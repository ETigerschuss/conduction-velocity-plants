...
kids.push(p([b("4. Modelling shows this montage cannot adjudicate active vs passive — and everything we record is consistent with passive spread. "), t("An active (delayed copy) model never out-fits a passive (delayed + dispersed) one: on waveform R² the passive model is strictly better in "), b("157 of 176 recordings and tied in the other 19"), t(" (where the fitted dispersion σ collapses to 0, making the two models identical) — "), b("active wins none"), t(". Under BIC, which penalises the passive model’s extra parameter, it still wins 153/176 — including in Venus flytrap and Mimosa, whose action potentials are independently established. We therefore report this as a "), b("negative / methodological result"), t(", not a per-species propagation-mode prediction (Section 6).")]));
